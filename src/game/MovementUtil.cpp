...
namespace Movement
{
    ...
    char const* g_MovementFlag_names[] =
    {
        ...
        STR(Root               ), // 0x00000800,
        STR(Jumping            ), // 0x00001000,
        STR(Unk4               ), // 0x00002000,
        STR(Falling            ), // 0x00004000,
        ...
        STR(Can_Fly            ), // 0x00800000,
        STR(Flying             ), // 0x01000000,
        STR(Flying2            ), // 0x02000000,               // Actual Flying Mode
    ...
    char const* g_SplineFlag_names[32] =
    {
        ...
        STR(Flying       ), // 0x00000200,           // Not Compartible With Trajectory Movement
        STR(No_Spline    ), // 0x00000400,
        STR(Unknown12    ), // 0x00000800,
        STR(Unknown13    ), // 0x00001000,
        STR(Unknown14    ), // 0x00002000,
        STR(Unknown15    ), // 0x00004000,           // Model Orientation Fixed
