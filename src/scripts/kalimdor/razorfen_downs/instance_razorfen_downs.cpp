...
{
    instance_razorfen_downs(Map *map) : ScriptedInstance(map){};
...
InstanceData* GetInstanceData_instance_razorfen_downs(Map* map)
{
    return new instance_razorfen_downs(map);
}
